...
public class RenderEnderBook extends TileEntitySpecialRenderer {

	private ModelBook bookModel = new ModelBook();
	
	@Override
	public void renderTileEntityAt(TileEntity var1, double par2, double par4, double par6, float par8) {
		TileEntityEnderbook par1TileEntityEnchantmentTable = (TileEntityEnderbook)var1;
		GL11.glPushMatrix();
        ...
        this.bindTextureByName("/demonmodders/crymod/resource/tex/enderBookEntity.png");
        ...
        this.bookModel.render((Entity)null, var9, var12, var13, var14, 0.0F, 0.0625F);
        GL11.glPopMatrix();
	}
